...
self.MonacoEnvironment = {
  getWorker(_moduleId, label) {
    if (['html', 'handlebars', 'razor', 'trafficops-tpl', 'trafficops-tpl-trusted'].includes(label)) return new HtmlWorker();
...
for (const id of ['trafficops-tpl', 'trafficops-tpl-trusted']) registerHTMLLanguageService(id, undefined, {
