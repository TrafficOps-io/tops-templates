...
Machine-readable profiles live in [`resources/dialects`](https://github.com/trafficops-io/tops-templates/tree/main/template-dsl/resources/dialects). They are descriptive fixtures for editors, importers and compatibility tests. Loading a JSON profile must not instantiate or authorize a dialect.
...
See [the threat model](https://github.com/trafficops-io/tops-templates/blob/main/docs/threat-model.md) before accepting a more permissive profile.
