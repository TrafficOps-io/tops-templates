...
export default function App() {
  ...
  return <div className={`studio ${workspaceExpanded ? 'workspace-expanded' : ''}`}>
    ...
    <main className="workspace">
      ...
      <div className={`editor-shell ${workspaceExpanded ? 'is-expanded' : 'is-compact'} ${filesCollapsed ? 'files-collapsed' : ''}`}>
        ...
        {workspaceExpanded && <PreviewPanel ready={ready} mobile={mobile} onMobileChange={setMobile} shownPage={shownPage} pageNames={pageNames} onPageChange={setPreviewPage} preview={preview} error={generated.error} />}
      </div>
