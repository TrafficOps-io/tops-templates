...
import { ArrowDownToLine, ArrowUpFromLine, Check, ChevronDown, Code2, FileCode2, FileImage, Files, FolderOpen, HelpCircle, LoaderCircle, Monitor, Pencil, Plus, RotateCcw, Settings2, ShieldCheck, Smartphone, Trash2, X } from 'lucide-react';
...
export default function App() {
  ...
  return <div className="studio">
    ...
    <main className="workspace">
      <div className="workspace-heading"><div><div className="eyebrow"><span /> YOUR NEXT PAGE STARTS HERE</div><h1>A little code. A lot of possibility.</h1><p>Shape your template, make it yours, take it anywhere.</p></div><div className="project-actions"><button className="btn btn-ghost btn-sm" onClick={() => setDialog('reset')}><Plus size={16} /> New project</button><button className="btn btn-outline btn-sm" disabled={busy} onClick={() => archiveInput.current?.click()}>{busy ? <LoaderCircle size={16} className="spin" /> : <ArrowUpFromLine size={16} />} Open ZIP</button></div></div>
